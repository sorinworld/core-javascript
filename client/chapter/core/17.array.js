...
// 배열 선언
let friends = 'df,sd,as,sd,ds'.split(','); //object wrapper가 왔다 간다{} - 원시객체
//let friends = ['df','sd','as','sd','ds']
...
// 배열 요소 추가
let unshift = friends.unshift('qh');
let push = friends.push('dn');

console.log(friends);

// 배열 요소 제거
let shift = friends.shift(); //제거된 요소 반환
let pop = friends.pop();
...
//참조에 의한 복사
// 배열 복사
let copiedArray = [...friends]; //spread operator 
