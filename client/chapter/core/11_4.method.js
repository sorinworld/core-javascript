...
//메소드를 한번 호출하고 난 다음 ladder를 내뱉으면 단축구문을 쉽게 쓸수있지않나 .up()

/* let ladder = {
  step: 0,
  up() {
    this.step++;
    return this //나를 다시 한번 내보낸다. 대상자체를 내보낸다. =메서드 체이닝
  },
  down() {
    this.step--;
    return this
...
// 배열엔 .property를 못쓴다. menu에 0번째에 접근
//메서드 안에서의 화살표 함수냐 일반함수냐 중요
const shopOrder = {
  date: '2022. 7. 6',
  tableIndex: 5,
  menu: [
  ...
  totalPrice(){ //화살표 함수는 window가 나온다 ->단축구문으로 바꾸면 찾음
